...
* added the metrics-operator ([5153a05](https://github.com/thisthat/lifecycle-controller/commit/5153a058d6eb30b6455941ee1d76dd09f98d6689))
...
* **operator:** accept LogLevels for all controllers  ([#790](https://github.com/thisthat/lifecycle-controller/issues/790)) ([d175486](https://github.com/thisthat/lifecycle-controller/commit/d175486fc10832458ebb95b17356fee4a2ccc1d7))
...
* **operator:** introduce fallback search to KLT default namespace when KeptnTaskDefinition is not found ([#1340](https://github.com/thisthat/lifecycle-controller/issues/1340)) ([6794fe2](https://github.com/thisthat/lifecycle-controller/commit/6794fe2d7e3334deb17dd13e5580bfc358edb57c))
...
* fixed helm chart generation to include crds directly in the template ([#801](https://github.com/thisthat/lifecycle-controller/issues/801)) ([f46e603](https://github.com/thisthat/lifecycle-controller/commit/f46e603782badb1dbb0761725920b245c0efb97e))
...
* **operator:** detect Job failure and set Task to failed ([#424](https://github.com/thisthat/lifecycle-controller/issues/424)) ([19114db](https://github.com/thisthat/lifecycle-controller/commit/19114db17d5ea01687b184962efcb048c28fdc40))
...
* use correct control-plane label for metrics-operator ([#1147](https://github.com/thisthat/lifecycle-controller/issues/1147)) ([1035183](https://github.com/thisthat/lifecycle-controller/commit/10351834d70b000b8296bea65b80fc9e22e54cee))
...
* update aquasecurity/trivy-action action to v0.9.1 ([#834](https://github.com/thisthat/lifecycle-controller/issues/834)) ([3db24f1](https://github.com/thisthat/lifecycle-controller/commit/3db24f1200e69d25afd9b80bec62f0d8d7c4b1d4))
...
* update dependency argoproj/argo-cd to v2.5.7 ([#649](https://github.com/thisthat/lifecycle-controller/issues/649)) ([ca5c106](https://github.com/thisthat/lifecycle-controller/commit/ca5c106d389eb4dc790c8beb3daaaf51cbfbdb20))
...
* update dependency jaegertracing/jaeger to v1.39.0 ([#440](https://github.com/thisthat/lifecycle-controller/issues/440)) ([3410b63](https://github.com/thisthat/lifecycle-controller/commit/3410b635d1bf17884e25b7fdbe56f336c189f246))
...
* update ghcr.io/podtato-head/left-leg docker tag to v0.2.8 ([#1218](https://github.com/thisthat/lifecycle-controller/issues/1218)) ([dd15d4a](https://github.com/thisthat/lifecycle-controller/commit/dd15d4a0e0e4b4986d8c3d0860662bfa8ad1110e))
...
* update golang.org/x/exp digest to a68e582 ([#653](https://github.com/thisthat/lifecycle-controller/issues/653)) ([d6fabf5](https://github.com/thisthat/lifecycle-controller/commit/d6fabf55d6a45d7bd5594fb59121eba2447e82d2))
...
* update module github.com/magiconair/properties to v1.8.7 ([#503](https://github.com/thisthat/lifecycle-controller/issues/503)) ([4f87239](https://github.com/thisthat/lifecycle-controller/commit/4f872397b28063b998091ed43a766b7f9c72fe75))
...
* update module github.com/prometheus/common to v0.37.1 ([#533](https://github.com/thisthat/lifecycle-controller/issues/533)) ([b72d52e](https://github.com/thisthat/lifecycle-controller/commit/b72d52eb1e940247f4accbf7e883edcf965dbd52))
...
* update module k8s.io/klog/v2 to v2.90.1 ([#982](https://github.com/thisthat/lifecycle-controller/issues/982)) ([90052bc](https://github.com/thisthat/lifecycle-controller/commit/90052bc059af2d67f1835fe5ba72b5fa3eb77941))
...
* add cert-manager to jaeger installation script ([#1020](https://github.com/thisthat/lifecycle-controller/issues/1020)) ([6dc6cee](https://github.com/thisthat/lifecycle-controller/commit/6dc6ceefe4b6aa9191229be77d2f97466d32f07a))
...
* contribution guide for the community ([#709](https://github.com/thisthat/lifecycle-controller/issues/709)) ([8b37dd7](https://github.com/thisthat/lifecycle-controller/commit/8b37dd7cd7fc4646552995da6829bf8cfccedb6e))
...
* misspelled file name, misordered pages ([#1363](https://github.com/thisthat/lifecycle-controller/issues/1363)) ([be3c2f1](https://github.com/thisthat/lifecycle-controller/commit/be3c2f1b469a15292bbd698af2200c0a4fb4002e))
...
* update KeptnConfig docs to include KeptnAppCreationRequestTimeout ([#1348](https://github.com/thisthat/lifecycle-controller/issues/1348)) ([117c263](https://github.com/thisthat/lifecycle-controller/commit/117c263f0e4da43f32c5b3603c792de9a1badf66))
* update KeptnTaskDefinition to include fallback search to default KLT namespace ([#1349](https://github.com/thisthat/lifecycle-controller/issues/1349)) ([2f5587e](https://github.com/thisthat/lifecycle-controller/commit/2f5587ed2407abe053ed6d8fb49ef7a7c1123eb4))
* update list of videos about KLT ([#1105](https://github.com/thisthat/lifecycle-controller/issues/1105)) ([ade49e1](https://github.com/thisthat/lifecycle-controller/commit/ade49e1fd8d4cb9b811fb4b4be871c1907f124ad))
* update README and CONTRIBUTING instructions ([#991](https://github.com/thisthat/lifecycle-controller/issues/991)) ([e42b750](https://github.com/thisthat/lifecycle-controller/commit/e42b750a64f3681efdfa64dd55fe3ade61f53c53))
* use helm charts instead of manifests + document KeptnConfig CRD ([#747](https://github.com/thisthat/lifecycle-controller/issues/747)) ([338c0fa](https://github.com/thisthat/lifecycle-controller/commit/338c0fa2042ef74cb253d49ce050c2f61ea24f95))
* website build improvements ([#806](https://github.com/thisthat/lifecycle-controller/issues/806)) ([03ce732](https://github.com/thisthat/lifecycle-controller/commit/03ce732d0cc72988c49b012df70c776cfdc8eb06))


### Other

* adapt CODEOWNERS to new team structure ([#1250](https://github.com/thisthat/lifecycle-controller/issues/1250)) ([0f11b85](https://github.com/thisthat/lifecycle-controller/commit/0f11b85474e54a1d7811bb5df90498e40e13ecda))
* add component tests as part of the coverage ([#468](https://github.com/thisthat/lifecycle-controller/issues/468)) ([d521669](https://github.com/thisthat/lifecycle-controller/commit/d521669abd2dd868a8e31eb9864bf61e018f2e21))
* add CONTRIBUTING.md file ([#466](https://github.com/thisthat/lifecycle-controller/issues/466)) ([02c2726](https://github.com/thisthat/lifecycle-controller/commit/02c272667d5296b1feedb9095c4f5dd72e7c7c10))
* add Hugo caching ([#958](https://github.com/thisthat/lifecycle-controller/issues/958)) ([b2f24fe](https://github.com/thisthat/lifecycle-controller/commit/b2f24fe4448edd24a3711e522caf393464ee877d))
* add maturity status for each feature ([#825](https://github.com/thisthat/lifecycle-controller/issues/825)) ([d5849c9](https://github.com/thisthat/lifecycle-controller/commit/d5849c9e4f6d1f7c05c30fb2534284ff3b8cc25b))
* add scarf pixel to markdown files ([#493](https://github.com/thisthat/lifecycle-controller/issues/493)) ([b05a810](https://github.com/thisthat/lifecycle-controller/commit/b05a810860d1286abdc72e9d1fe0ef4204453018))
* add StackScribe as Code Owner of docs ([#821](https://github.com/thisthat/lifecycle-controller/issues/821)) ([c90db1e](https://github.com/thisthat/lifecycle-controller/commit/c90db1e6d848248c05032572dfad86fbda610bf0))
* added sonar-project.properties file and adapted codecov settings ([#989](https://github.com/thisthat/lifecycle-controller/issues/989)) ([ca1c6ba](https://github.com/thisthat/lifecycle-controller/commit/ca1c6bad8e9f6983c2a781ea761201cabeeff954))
* adjust manifest limits ([#891](https://github.com/thisthat/lifecycle-controller/issues/891)) ([32ce1b0](https://github.com/thisthat/lifecycle-controller/commit/32ce1b01ea71fc0d52f5848144af6675289a39f0))
* bump go to 1.20 ([#1294](https://github.com/thisthat/lifecycle-controller/issues/1294)) ([0a6ac23](https://github.com/thisthat/lifecycle-controller/commit/0a6ac23eb77e2b5f8bdd20028309254dda2c9d1d))
* bump GO_VERSION to 1.20 in pipelines ([#1326](https://github.com/thisthat/lifecycle-controller/issues/1326)) ([7e8079e](https://github.com/thisthat/lifecycle-controller/commit/7e8079ecfcd612bc31f581e66f76e4c895283efc))
* bump up helm chart version ([#1351](https://github.com/thisthat/lifecycle-controller/issues/1351)) ([737d478](https://github.com/thisthat/lifecycle-controller/commit/737d4782c6c90c77930f58590dcd1098b68b6ef1))
* **cert-manager:** reduce secret permissions ([#1295](https://github.com/thisthat/lifecycle-controller/issues/1295)) ([bd8de3b](https://github.com/thisthat/lifecycle-controller/commit/bd8de3b6461fcd599b58461ffbf42ff2e087951e))
* close issues and PRs if they get stale ([#1041](https://github.com/thisthat/lifecycle-controller/issues/1041)) ([89e03c2](https://github.com/thisthat/lifecycle-controller/commit/89e03c21476cc6cd98ca6e1c1bef95384c8495f4))
* enhance golangci-lint with code complexity and other measures ([#484](https://github.com/thisthat/lifecycle-controller/issues/484)) ([1d711d0](https://github.com/thisthat/lifecycle-controller/commit/1d711d09b181ea72277ac6cb43f1ac605e82955f))
* ensures that PR subjects start with lowercase ([#427](https://github.com/thisthat/lifecycle-controller/issues/427)) ([246f0b6](https://github.com/thisthat/lifecycle-controller/commit/246f0b6b81849f7c9202a6a17623157d9623f540))
* execute performance tests after all other tests have been executed ([#479](https://github.com/thisthat/lifecycle-controller/issues/479)) ([145a6ab](https://github.com/thisthat/lifecycle-controller/commit/145a6abeec614a3e75787c93da98b2ee3dca8ed1))
* fail linter CI jobs when checks are failing ([#630](https://github.com/thisthat/lifecycle-controller/issues/630)) ([a5e0eaa](https://github.com/thisthat/lifecycle-controller/commit/a5e0eaaf040026fedfa08f065b97b8de315b4132))
* fix failing component test ([#1282](https://github.com/thisthat/lifecycle-controller/issues/1282)) ([00fd1f3](https://github.com/thisthat/lifecycle-controller/commit/00fd1f3f2f6bd8e4d547d7e6b14cbd9fe9e14d42))
* fix golangci-lint errors ([#905](https://github.com/thisthat/lifecycle-controller/issues/905)) ([a133fdd](https://github.com/thisthat/lifecycle-controller/commit/a133fdd99515765642d354c3a0cea51408333d99))
* fix markdown linter errors ([#824](https://github.com/thisthat/lifecycle-controller/issues/824)) ([5df8789](https://github.com/thisthat/lifecycle-controller/commit/5df87899038bd6205b51d87f0954d2b3b616868a))
* improve CRD docs generation script output ([#1157](https://github.com/thisthat/lifecycle-controller/issues/1157)) ([b27adf1](https://github.com/thisthat/lifecycle-controller/commit/b27adf1edc297dd7723998fcf4960929b2b2952d))
* improve Makefiles usage ([#921](https://github.com/thisthat/lifecycle-controller/issues/921)) ([2761a4d](https://github.com/thisthat/lifecycle-controller/commit/2761a4dad36f452b2dd575ab5ec1572b68602165))
* improve markdownlint ([#946](https://github.com/thisthat/lifecycle-controller/issues/946)) ([d5d1675](https://github.com/thisthat/lifecycle-controller/commit/d5d1675010cf0d3b8b506ef0a24c19d284d67727))
* **metrics-operator:** add configuration parameters for container securityContext ([#1290](https://github.com/thisthat/lifecycle-controller/issues/1290)) ([27439ff](https://github.com/thisthat/lifecycle-controller/commit/27439ff3ad9fff30341fb987fd06ecb3aaef0d1d))
* **metrics-operator:** restrict custom metrics ClusterRole privileges ([#1330](https://github.com/thisthat/lifecycle-controller/issues/1330)) ([6f59a6c](https://github.com/thisthat/lifecycle-controller/commit/6f59a6c0c75d79a54a874fcda64181180723551b))
* minor refactoring of the evaluation controller ([#1356](https://github.com/thisthat/lifecycle-controller/issues/1356)) ([4398e96](https://github.com/thisthat/lifecycle-controller/commit/4398e9677ca60a4dd10bd7198479796f36f26026))
* move to new theme repo for docs ([74903a4](https://github.com/thisthat/lifecycle-controller/commit/74903a481b69d3eb36c67652ea48b495b4f9fb3d))
* **operator:** fix linter issues ([#579](https://github.com/thisthat/lifecycle-controller/issues/579)) ([64603fb](https://github.com/thisthat/lifecycle-controller/commit/64603fbe728631b7f84e79552b39ad34957e60ea))
* **operator:** read-only RBAC for KeptnConfig controller ([#1096](https://github.com/thisthat/lifecycle-controller/issues/1096)) ([ea91ff3](https://github.com/thisthat/lifecycle-controller/commit/ea91ff36dfbe13811143031462407fecf7791596))
* **operator:** refactor operator and scheduler statuses + add unit tests ([#548](https://github.com/thisthat/lifecycle-controller/issues/548)) ([c661dc0](https://github.com/thisthat/lifecycle-controller/commit/c661dc063544835e3854b20c06c22ed536529511))
* **operator:** remove KeptnMetric and KeptnEvaluationProvider from klt operator ([91e57ca](https://github.com/thisthat/lifecycle-controller/commit/91e57cadba32fce6d873bc480408f90bcb8964d9))
* **operator:** restructure packages ([#469](https://github.com/thisthat/lifecycle-controller/issues/469)) ([41f21eb](https://github.com/thisthat/lifecycle-controller/commit/41f21ebbd7839a64cbdb5c4f49061eab9f66976f))
* polish examples and integration tests ([#956](https://github.com/thisthat/lifecycle-controller/issues/956)) ([72d3c9e](https://github.com/thisthat/lifecycle-controller/commit/72d3c9ee086c203431120f6899a274180882fac4))
* refactor and add unit tests to watcher ([#1253](https://github.com/thisthat/lifecycle-controller/issues/1253)) ([4b40b7e](https://github.com/thisthat/lifecycle-controller/commit/4b40b7ecccecc3bccaccc0532be1cd16d9c7ba6a))
* release 0.4.1 ([#358](https://github.com/thisthat/lifecycle-controller/issues/358)) ([3359d2b](https://github.com/thisthat/lifecycle-controller/commit/3359d2b5f48c48e145d85604c12c93d5a3363c56))
* release 0.5.0 ([#490](https://github.com/thisthat/lifecycle-controller/issues/490)) ([7dc3ec5](https://github.com/thisthat/lifecycle-controller/commit/7dc3ec5df5326c8bc4940cfb68cbb90d4ae8d3aa))
* release 0.6.0 ([#592](https://github.com/thisthat/lifecycle-controller/issues/592)) ([c9a5fb5](https://github.com/thisthat/lifecycle-controller/commit/c9a5fb5c566e28f644e6816b0d255dc33a8d812c))
* release 0.7.0 ([#1056](https://github.com/thisthat/lifecycle-controller/issues/1056)) ([70a1854](https://github.com/thisthat/lifecycle-controller/commit/70a18545361573ee96b83a09ce043cb113f52a33))
* release 0.7.0 ([#843](https://github.com/thisthat/lifecycle-controller/issues/843)) ([bade181](https://github.com/thisthat/lifecycle-controller/commit/bade181b735c7e069c510424ad5350476e41eeba))
* release 0.7.1 ([#1089](https://github.com/thisthat/lifecycle-controller/issues/1089)) ([d5000da](https://github.com/thisthat/lifecycle-controller/commit/d5000da9b2aa8c02ae0b10129b7066ddd9a573fb))
* remove cert-manager leftovers ([#1216](https://github.com/thisthat/lifecycle-controller/issues/1216)) ([1c58ba8](https://github.com/thisthat/lifecycle-controller/commit/1c58ba8edc2320d58096dea1f8beecfdc8c949b5))
* remove generated fake folder from sonar checks ([#1021](https://github.com/thisthat/lifecycle-controller/issues/1021)) ([ec4ccb9](https://github.com/thisthat/lifecycle-controller/commit/ec4ccb976117f88fc70afbdadd0b8c93da81edff))
* remove golang exp dependency ([#919](https://github.com/thisthat/lifecycle-controller/issues/919)) ([c5c3fdf](https://github.com/thisthat/lifecycle-controller/commit/c5c3fdfc822f8da629c1114f78ce31861e4c286a))
* reorder integration test execution ([#1264](https://github.com/thisthat/lifecycle-controller/issues/1264)) ([71f2f78](https://github.com/thisthat/lifecycle-controller/commit/71f2f787072627c807c2802bc57d016ee5b51d1b))
* revert test makefile changes ([#1281](https://github.com/thisthat/lifecycle-controller/issues/1281)) ([2261a4a](https://github.com/thisthat/lifecycle-controller/commit/2261a4ab055095ad6d92b991e5520ff76ad9ba86))
* run CI also on epic branches ([#853](https://github.com/thisthat/lifecycle-controller/issues/853)) ([a2f7cce](https://github.com/thisthat/lifecycle-controller/commit/a2f7cce17a7622ca8d5cbd9daaacc711d96b2660))
* **scheduler:** added new scheduler tests ([#634](https://github.com/thisthat/lifecycle-controller/issues/634)) ([2e47b92](https://github.com/thisthat/lifecycle-controller/commit/2e47b9227b7622af703311b1be69b7e0706c4700))
* **scheduler:** make RealAnna codeowner ([#369](https://github.com/thisthat/lifecycle-controller/issues/369)) ([aba0a70](https://github.com/thisthat/lifecycle-controller/commit/aba0a708c3aace2d2309fa571e073d90ad6d6861))
* set new documentation approach live ([#1007](https://github.com/thisthat/lifecycle-controller/issues/1007)) ([f3511f1](https://github.com/thisthat/lifecycle-controller/commit/f3511f1f5efec86fb1c86a6c7e39790d662417f9))
* set up YAML linter rules, fix YAML files accordingly ([#1174](https://github.com/thisthat/lifecycle-controller/issues/1174)) ([86fbb75](https://github.com/thisthat/lifecycle-controller/commit/86fbb757e55cb959e8ccb2ddc62bfcba55271452))
* stop linter CI job on error ([#631](https://github.com/thisthat/lifecycle-controller/issues/631)) ([c5463c6](https://github.com/thisthat/lifecycle-controller/commit/c5463c621267859ac56d53a4ec6b0458e62db9f9))
* stop pushing dev container images to GHCR ([#1192](https://github.com/thisthat/lifecycle-controller/issues/1192)) ([fa53443](https://github.com/thisthat/lifecycle-controller/commit/fa53443c704193db029c92ff4ad08fc2bfaaa24d))
* switch to registry.k8s.io in yaml files in prometheus example ([#870](https://github.com/thisthat/lifecycle-controller/issues/870)) ([909a1d6](https://github.com/thisthat/lifecycle-controller/commit/909a1d6fd8788545e6d7cbee1351c7d574e1f39c))
* unify EvaluationStatus and TaskStatus to single structure ([#569](https://github.com/thisthat/lifecycle-controller/issues/569)) ([9b31b04](https://github.com/thisthat/lifecycle-controller/commit/9b31b04546fb600735e18ed3d522b85453bf5be5))
* update codeowners to have default owners for docs folder ([#827](https://github.com/thisthat/lifecycle-controller/issues/827)) ([82351f4](https://github.com/thisthat/lifecycle-controller/commit/82351f4458d715607f356a04e343477b2937f564))
* update observability demo link ([#666](https://github.com/thisthat/lifecycle-controller/issues/666)) ([53e53f1](https://github.com/thisthat/lifecycle-controller/commit/53e53f1ccb81e397f415dcaea53a6a7c1589daf3))
* upgrade examples and tests to v1alpha2 ([#509](https://github.com/thisthat/lifecycle-controller/issues/509)) ([2a133ea](https://github.com/thisthat/lifecycle-controller/commit/2a133eaef43fa800fe937f7a5cde115d78e4b5fb))
* upgraded metrics operator to go 1.19 ([#1017](https://github.com/thisthat/lifecycle-controller/issues/1017)) ([c2238fa](https://github.com/thisthat/lifecycle-controller/commit/c2238fa2765bf5295720c9777e80f16f2b3ee289))
